...
def login_to_chatgpt(page):
    ...
    page.get_by_role("textbox", name="Email address").fill("mrkapaul164@gmail.com")
    page.locator("//*[@id=':r1:']/div[2]/button").click()
    page.locator('//*[@id="identifierNext"]/div/button/div[3]').click()
    page.wait_for_timeout(2000)
    page.locator('//*[@id="password"]/div[1]/div/div[1]/input').fill("sandeep@164")
    page.locator('//*[@id="passwordNext"]/div/button/span').click()
    page.locator("//button[text()='Accept']").click()
